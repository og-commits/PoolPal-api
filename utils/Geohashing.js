...
class Geohash {
    ...
    static neighbours(geohash) {
        return [
            ...
            Geohash.adjacent(Geohash.adjacent(geohash, 'n'), 'e'),
            Geohash.adjacent(geohash, 'e'),
            Geohash.adjacent(Geohash.adjacent(geohash, 's'), 'e'),
            Geohash.adjacent(geohash, 's'),
            Geohash.adjacent(Geohash.adjacent(geohash, 's'), 'w'),
            Geohash.adjacent(geohash, 'w'),
            Geohash.adjacent(Geohash.adjacent(geohash, 'n'), 'w')
        ];
    }
